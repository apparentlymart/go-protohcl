...
const (
	...
	// extension type.
	Attribute_Raw_MESSAGEPACK Attribute_Raw_Mode = 0
	// JSON can encode all _known_ HCL values, but cannot encode unknown
	// values.
	Attribute_Raw_JSON Attribute_Raw_Mode = 1
)

// Enum value maps for Attribute_Raw_Mode.
var (
	Attribute_Raw_Mode_name = map[int32]string{
		0: "MESSAGEPACK",
		1: "JSON",
	}
	Attribute_Raw_Mode_value = map[string]int32{
		"MESSAGEPACK": 0,
		"JSON":        1,
	}
)

func (x Attribute_Raw_Mode) Enum() *Attribute_Raw_Mode {
	p := new(Attribute_Raw_Mode)
	*p = x
	return p
}

func (x Attribute_Raw_Mode) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (Attribute_Raw_Mode) Descriptor() protoreflect.EnumDescriptor {
	return file_hcl_proto_enumTypes[0].Descriptor()
}

func (Attribute_Raw_Mode) Type() protoreflect.EnumType {
	return &file_hcl_proto_enumTypes[0]
}

func (x Attribute_Raw_Mode) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use Attribute_Raw_Mode.Descriptor instead.
func (Attribute_Raw_Mode) EnumDescriptor() ([]byte, []int) {
	return file_hcl_proto_rawDescGZIP(), []int{0, 0, 0}
}
...
type Attribute struct {
	...
	// configuration. If unset, protohcl will use the proto field name.
	// Attribute names and nested block types must be unique within a
	// particular message, including any other message types that "flatten"
	// into their parent.
	...
	Raw *Attribute_Raw `protobuf:"bytes,4,opt,name=raw,proto3" json:"raw,omitempty"`
}
...
func (x *Attribute) GetRaw() *Attribute_Raw {
	if x != nil {
		return x.Raw
	}
	return nil
...
type Attribute_Raw struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// The serialization format to use to serialize the raw HCL value.
	//
	// The chosen serialization format will constrain what subset of HCL
	// values can be encoded. None of the encoding formats can preserve
	// "marked" values, in applications which use them; those must be
	// sent out-of-band if needed.
	Format Attribute_Raw_Mode `protobuf:"varint,1,opt,name=format,proto3,enum=hcl.Attribute_Raw_Mode" json:"format,omitempty"`
}

func (x *Attribute_Raw) Reset() {
	*x = Attribute_Raw{}
	if protoimpl.UnsafeEnabled {
...
func (x *Attribute_Raw) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Attribute_Raw) ProtoMessage() {}

func (x *Attribute_Raw) ProtoReflect() protoreflect.Message {
	mi := &file_hcl_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Attribute_Raw.ProtoReflect.Descriptor instead.
func (*Attribute_Raw) Descriptor() ([]byte, []int) {
	return file_hcl_proto_rawDescGZIP(), []int{0, 0}
}

func (x *Attribute_Raw) GetFormat() Attribute_Raw_Mode {
	if x != nil {
		return x.Format
	}
	return Attribute_Raw_MESSAGEPACK
}
...
var file_hcl_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0xd0, 0x01, 0x0a, 0x09, 0x41, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65,
	...
	,
	...
	0x65, 0x22, 0x20, 0x0a, 0x0a, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x4c, 0x61, 0x62, 0x65, 0x6c, 0x12,
...
var file_hcl_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_hcl_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_hcl_proto_goTypes = []interface{}{
	(Attribute_Raw_Mode)(0),         // 0: hcl.Attribute.Raw.Mode
	(*Attribute)(nil),               // 1: hcl.Attribute
	(*NestedBlock)(nil),             // 2: hcl.NestedBlock
	(*BlockLabel)(nil),              // 3: hcl.BlockLabel
	(*Attribute_Raw)(nil),           // 4: hcl.Attribute.Raw
	(*descriptor.FieldOptions)(nil), // 5: google.protobuf.FieldOptions
}
var file_hcl_proto_depIdxs = []int32{
	4, // 0: hcl.Attribute.raw:type_name -> hcl.Attribute.Raw
	0, // 1: hcl.Attribute.Raw.format:type_name -> hcl.Attribute.Raw.Mode
	...
	1, // 6: hcl.attr:type_name -> hcl.Attribute
	2, // 7: hcl.block:type_name -> hcl.NestedBlock
	3, // 8: hcl.label:type_name -> hcl.BlockLabel
